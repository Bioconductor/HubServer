...
type of database you are using:
    ...
    export HUBSERVER_DATABASE_TYPE=sqlite
...
* Use one of the sample config.yml files as a template

* Variables:

* Old set:
    - mysql_url: "mysql://user:password@host/dbname"
    - sqlite_filename: db name with ".sqlite3" extension
    - admin_password: "some_password"
    - logging_url: "mysql://username:password@host/logging_database_name"
