...
if ENV['HUBSERVER_DATABASE_TYPE'] == 'mysql'
    ...
    _DB.run "use #{dbname};"
elsif ENV['HUBSERVER_DATABASE_TYPE'] == 'sqlite'
...
for table in DB.tables 
    ...
    for op in ['insert', 'update', 'delete']
        trigger = nil
        if ENV['HUBSERVER_DATABASE_TYPE'] == 'sqlite'
            trigger=<<-"EOT"
            ...
            EOT
        elsif ENV['HUBSERVER_DATABASE_TYPE'] == 'mysql'
            trigger=<<-"EOT"
